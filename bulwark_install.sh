...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bulwark.conf'
CONFIGFOLDER='/root/.bulwark'
COIN_DAEMON='bulwarkd'
COIN_CLI='bulwark-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/bulwark-crypto/Bulwark/releases/download/1.3.0/bulwark-1.3.0.0-linux64.tar.gz'
